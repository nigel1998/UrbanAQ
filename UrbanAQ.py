...
if (navigation == 'Data Visualizations'):
    ...
    my_expander2.markdown("<p style='text-align: justify;'><b>For NO<sub>2</sub> daily satellite data visualization images, please visit our <a href ='https://drive.google.com/drive/folders/1_rSpbM3b_X6l1qiRRNSH9mM6Nqcdjw3J?usp=sharing', target='_blank'>public drive</a>.</b></p>", unsafe_allow_html=True)    
