...
def home():
    ...
    select_pollutant_intro= col2.selectbox('Select Pollutant:', ['PM 2.5', 'NO2'], key='about')
...
def DataVisualization():
    ...
    my_expander2.markdown("<p style='text-align: justify;'>Please use the sidebar at the left side of the page to choose your city and pollutant of interest.</p>", unsafe_allow_html=True)  
    ...
    select_pollutant = st.sidebar.selectbox('Select Pollutant:', ['<select>','PM 2.5', 'NO2'], help="Filter data by Pollutant, which will be displayed under the 'Data Visualizations' expander on button click.", key='sel_pol')
...
def DataDownload():
    ...
    my_expander3.markdown("<p style='text-align: justify;'>Please use the sidebar at the left side of the page to choose your city and pollutant of interest.</p>", unsafe_allow_html=True)
    ...
    if all_select_pollutant1:
        select_pollutant1 = container_select_pollutant1.multiselect('Select Pollutant:', ['PM 2.5', 'NO2'], ['PM 2.5', 'NO2'], help="Filter data by Pollutant, which will be displayed under the 'Data Download' expander on button click.")
    else:
        select_pollutant1 = container_select_pollutant1.multiselect('Select Pollutant:', ['PM 2.5', 'NO2'], help="Filter data by Pollutant, which will be displayed under the 'Data Download' expander on button click.")


    if (select_pollutant1 == ['PM 2.5', 'NO2']):
        df1 = df1
